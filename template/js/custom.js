...
// EXPAND/CLOSE BLOC DROITE ONE
$("#closeBone").on("click", function() {
    $("#displayBone").toggleClass("d-none");
    $("#svgBone").toggleClass("downSvg");
});

// EXPAND/CLOSE BLOC DROITE DEUX
$("#closeBtwo").on("click", function() {
    $("#displayBtwo").toggleClass("d-none");
    $("#svgBtwo").toggleClass("downSvg");
});
